// combined-server.js - Single server for both API and frontend
...
app.use(cors({
  // Since frontend and backend are on the same domain, we can just
...
// Explicitly bind to all network interfaces (0.0.0.0) for cloud deployment compatibility
